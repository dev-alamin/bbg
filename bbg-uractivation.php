...
function get_all_code_from_db()
{
    ...
    $sql = "SELECT * FROM $table LIMIT 4400, 20";
    ...
    // $unique_codes = array_map('strtoupper', $unique_codes );

    // for ($i = 0; $i < count( $unique_codes ); $i++) {
    //     $data = strip_tags($unique_codes[$i]);
    //     $data = trim($data);
    //     $data = stripcslashes($data);
    //     $data = stripslashes($data);

    //     $wpdb->query("INSERT INTO $db_table (code) VALUES('$data')");
    // }
}
